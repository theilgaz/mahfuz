...
export const THEMES: QuranTheme[] = [
  { id: "tawhid",      label: "Tevhid",         desc: "Allah'ın birliği ve eşsizliği" },
  { id: "iman",        label: "İman",            desc: "İman esasları ve hakikati" },
  { id: "quran",       label: "Kuran",           desc: "Kitabın fazileti ve özellikleri" },
  { id: "risalah",     label: "Nübüvvet",        desc: "Peygamberlik ve risalet" },
  { id: "salah",       label: "Namaz",           desc: "Namaz ve ibadet" },
  { id: "zakat",       label: "Zekat",           desc: "Zekat ve sadaka" },
  { id: "sawm",        label: "Oruç",            desc: "Oruç ve Ramazan" },
  { id: "hajj",        label: "Hac",             desc: "Hac ve umre" },
  { id: "dua",         label: "Dua",             desc: "Dua ve Allah'a yakarma" },
  { id: "akhirah",     label: "Ahiret",          desc: "Ölüm sonrası ve hesap günü" },
  { id: "jannah",      label: "Cennet",          desc: "Cennet ve ebedi nimet" },
  { id: "jahannam",    label: "Cehennem",        desc: "Cehennem ve azap" },
  { id: "kiyamet",     label: "Kıyamet",         desc: "Büyük gün ve alametleri" },
  { id: "prophets",    label: "Peygamberler",    desc: "Peygamber kıssaları (genel)" },
  { id: "ibrahim",     label: "Hz. İbrahim",     desc: "İbrahim peygamberin kıssası" },
  { id: "musa",        label: "Hz. Musa",        desc: "Musa peygamberin kıssası" },
  { id: "isa",         label: "Hz. İsa",         desc: "İsa peygamberin kıssası" },
  { id: "nuh",         label: "Hz. Nuh",         desc: "Nuh peygamberin kıssası" },
  { id: "yusuf",       label: "Hz. Yusuf",       desc: "Yusuf peygamberin kıssası" },
  { id: "muhammad",    label: "Hz. Muhammed",    desc: "Son peygamberin hayatı" },
  { id: "creation",    label: "Yaratılış",       desc: "Evrenin ve insanın yaratılışı" },
  { id: "nature",      label: "Tabiat",          desc: "Doğa ve kozmolojik ayetler" },
  { id: "signs",       label: "Deliller",        desc: "Allah'ın varlığının delilleri" },
  { id: "knowledge",   label: "İlim",            desc: "Bilgi, akıl ve hikmet" },
  { id: "guidance",    label: "Hidayet",         desc: "Doğru yol ve rehberlik" },
  { id: "tawbah",      label: "Tevbe",           desc: "Tövbe ve bağışlanma" },
  { id: "patience",    label: "Sabır",           desc: "Sabır ve azim" },
  { id: "gratitude",   label: "Şükür",           desc: "Şükür ve minnet" },
  { id: "ethics",      label: "Ahlak",           desc: "Güzel ahlak ve fazilet" },
  { id: "tawakkul",    label: "Tevekkül",        desc: "Allah'a güven ve dayanma" },
  { id: "family",      label: "Aile",            desc: "Nikah, aile ve miras" },
  { id: "justice",     label: "Adalet",          desc: "Hak, hukuk ve adalet" },
  { id: "community",   label: "Toplum",          desc: "Ümmet ve sosyal düzen" },
  { id: "jihad",       label: "Cihad",           desc: "Mücadele ve savunma" },
  { id: "munafiqun",   label: "Münafıklar",      desc: "Nifak ve ikiyüzlülük" },
  { id: "ahlu_kitab",  label: "Ehl-i Kitap",     desc: "Yahudi ve Hristiyanlar" },
  { id: "history",     label: "Tarih",           desc: "Geçmiş kavimlerin kıssaları" },
  { id: "rizq",        label: "Rızık",           desc: "Geçim, bereket ve şükür" },
  { id: "soul",        label: "Ruh/Nefis",       desc: "İnsan psikolojisi ve ruh" },
  { id: "charity",     label: "İnfak",           desc: "Yardım, bağış ve cömertlik" },
];
