    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "50vh", padding: "1rem", textAlign: "center", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem", justifyContent: "center" }}>
        <button
          ...
          style={{ padding: "0.5rem 1.125rem", borderRadius: 999, fontSize: "0.875rem", fontWeight: 500, background: "var(--mu-accent-soft)", color: "var(--mu-accent-ink)", border: "none", cursor: "pointer" }}
        >
          {retry}
        </button>
        <Link
          to="/"
          style={{ padding: "0.5rem 1.125rem", borderRadius: 999, fontSize: "0.875rem", fontWeight: 500, border: "1px solid var(--color-border, #ccc)", color: "var(--color-text-primary, #333)", textDecoration: "none" }}
        >
          {home}
        </Link>
        <a
          ...
          style={{ display: "flex", alignItems: "center", gap: "0.375rem", padding: "0.5rem 1.125rem", borderRadius: 999, fontSize: "0.875rem", fontWeight: 500, border: "1px solid var(--color-border, #ccc)", color: "var(--color-text-primary, #333)", textDecoration: "none" }}
        >
