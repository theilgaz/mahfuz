/**
 * Mahfuz lettermark logo -- Meem (م) inside Arsenal-style crest.
 */
...
// Arsenal-style crest paths (viewBox 0 0 323 380)
...
export function MahfuzLogo({ className, size }: MahfuzLogoProps) {
  ...
  return (
    <svg
      ...
      height={s}
    >
      <path d={OUTER} fill="#9C824A" />
      <path d={INNER} fill="#9e2a2b" />
      <path d={WHITE_L} fill="#fff" />
      <path d={WHITE_R} fill="#fff" />
      <path d={RED_L} fill="#c53637" />
      <path d={RED_R} fill="#ab2c2c" />
      <defs>
        <clipPath id="ml-ac">
          <path d={INNER} />
        </clipPath>
