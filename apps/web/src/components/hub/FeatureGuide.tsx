    ...
    <section className="mb-6">
      ...
      <div className="flex gap-2.5 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-none sm:grid sm:grid-cols-4 sm:overflow-visible">
        {FEATURES.map((f) => {
          ...
          const card = (
            <div
              className={`snap-start shrink-0 w-[8.5rem] h-[8.5rem] sm:w-auto sm:h-full flex flex-col items-center justify-center gap-1.5 p-3.5 rounded border transition-all ${
                f.disabled
