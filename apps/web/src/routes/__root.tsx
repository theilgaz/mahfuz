...
function RootDocument({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect width="32" height="32" rx="7" fill="${bg}"/><svg x="2" y="2" width="28" height="28" viewBox="0 0 100 100"><circle cx="50" cy="50" r="46" fill="none" stroke="${fg}" stroke-width="5"/><g transform="translate(33,10) scale(1.18)"><path fill="${fg}" d="${MEEM_PATH}"/></g></svg></svg>`;
