...
function RootDocument({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect width="32" height="32" rx="7" fill="${bg}"/><svg x="3" y="1" width="26" height="31" viewBox="0 0 100 120"><path d="M5 8 Q5 2 12 2 L88 2 Q95 2 95 8 L95 55 Q95 85 50 118 Q5 85 5 55 Z" fill="${fg}"/><defs><clipPath id="fsc"><path d="M10 12 Q10 7 16 7 L84 7 Q90 7 90 12 L90 53 Q90 80 50 112 Q10 80 10 53 Z"/></clipPath></defs><g clip-path="url(%23fsc)"><g transform="translate(32,4) scale(1.28)"><path fill="#fff" d="${MEEM_PATH}"/></g></g></svg></svg>`;
