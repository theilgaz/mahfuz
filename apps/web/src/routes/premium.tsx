  ...
  return (
    <div className="py-3 px-1 border-b border-[var(--color-border)]">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-[var(--color-text-secondary)] opacity-50 font-medium">{t.premium.comingSoon}</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="max-w-3xl mx-auto pb-28">
      ...
      <div className="mx-4 mt-6 rounded bg-[var(--color-accent)] px-6 pt-10 pb-8 text-white text-center">
        <p className="text-xs font-semibold tracking-widest opacity-70 mb-3">{t.premium.heroLabel}</p>
      ...
      <div className="px-4 mt-10">
        <Label>{t.premium.freeForever}</Label>
        <div className="grid grid-cols-4 gap-3">
          {FREE_FEATURES.map((f) => (
            ...
            >
              ...
              <span className="text-[10px] font-medium text-[var(--color-text-secondary)] text-center leading-tight">{t.premium[f.labelKey]}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="px-4 mt-10">
        <div className="flex items-center justify-between mb-4 px-1">
          ...
          <span className="text-[11px] font-medium text-[var(--color-accent)]">{t.premium.comingSoon}</span>
        </div>
        <div className="grid grid-cols-2 gap-3">
          {MODULES.map((m) => (
            ...
            >
              ...
              <p className="text-sm font-semibold text-[var(--color-text-primary)] leading-snug mb-1">{t.premium[m.titleKey]}</p>
              <p className="text-xs text-[var(--color-text-secondary)] leading-relaxed">{t.premium[m.descKey]}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Voluntary support */}
      <div className="px-4 mt-10">
        <Label>{t.premium.voluntarySupport}</Label>
