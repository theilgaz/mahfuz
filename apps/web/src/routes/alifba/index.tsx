        ...
        {ARABIC_LETTERS.map((letter) => {
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-center gap-1 py-3 px-1 rounded-xl border transition-colors active:scale-95 ${
                isMastered
            ...
            >
              <span className="text-2xl leading-none" style={{ fontFamily: "var(--font-arabic)" }}>
                {letter.arabic}
              </span>
