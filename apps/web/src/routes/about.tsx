...
function AboutPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 pb-32">
      ...
      {/* App kimlik kartı */}
      <div className="py-3 px-1 border-b border-[var(--color-border)] mb-6 flex items-center gap-4">
        <div className="w-14 h-14 rounded bg-[var(--color-accent)]/10 flex items-center justify-center shrink-0">
